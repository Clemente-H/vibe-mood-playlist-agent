...
export function SpotifyModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-gradient-to-br from-gray-900 to-black p-8 shadow-2xl">
        ...
        {/* Login Button */}
        <button className="w-full rounded-full bg-green-500 py-3 font-bold text-black transition-all duration-200 hover:bg-green-400 hover:scale-105">
          Login with Spotify
        </button>
